...
class pikapika():
    ...
    def frame_main(self, _pos1=pos1, _pos2=pos2, _pos3=pos3, _pos4=pos4, _pos5=pos5, _pos6=pos6, _pos7=pos7, _pos8=pos8, rm_pos=[], light_time=0.1):
    ...
    def main_thunder(self):
        clear_pos()
        _thunder_time = 0.00001

        for i in range(10):
            inp_color(all_pos, thunder)
            strip.show()
            time.sleep(0.0001)
            clear_pos(_sleep_time=0.0001)
        ...
        strip.show()
        time.sleep(0.7)
        clear_pos(_sleep_time=0.6)

       


        for i in range(40, 1, -1):
            self.frame_main(_pos4=pos4[i:], rm_pos=["p1", "p2", "p3", "p5", "p6", "p7", "p8"], light_time=_thunder_time)
        for i in range(40, 1, -1):
            self.frame_main(_pos3=pos3[i:], rm_pos=["p1", "p2", "p5", "p6", "p7", "p8"], light_time=_thunder_time)
        for i in range(40, 1, -1):
            self.frame_main(_pos2=pos2[i:], rm_pos=["p1", "p5", "p6", "p7", "p8"], light_time=_thunder_time)
        for i in range(35, 1, -1):
            self.frame_main(_pos1=pos1[i:], rm_pos=["p5", "p6", "p7", "p8"], light_time=_thunder_time)
...
#            self.frame_main(_pos1=pos1[i:], _pos8=pos8[:i])
        ...
        for i in range(5, 15):
            self.frame_main(_pos5=pos5[i:], _pos8=pos8[:i], rm_pos=["p1", "p8", "p4", "p7"])
        for i in range(30, 25, -1):
            self.frame_main(_pos4=pos4[i:], _pos7=pos7[:i], rm_pos=["p1", "p2", "p6", "p5"])
            
        for i in range(15, 10, -1):
            self.frame_main(_pos1=pos1[i:], _pos8=pos8[:i], rm_pos=["p3", "p6"])
        for i in range(10, 30):
            self.frame_main(_pos3=pos1[i:], _pos6=pos6[:i], rm_pos=["p4", "p7"])
